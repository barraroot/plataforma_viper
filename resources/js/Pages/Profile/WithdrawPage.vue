                            ...
                            <div class="mt-5">
                                ...
                                <div class="dark:text-gray-400 mb-3 mt-4">
                                    <div class="flex justify-between text-sm">
                                        ...
                                        <p>Saldo: {{ state.currencyFormat(parseFloat(wallet.total_balance), wallet.currency) }}</p>
                                    </div>
                                    ...
                                    <div class="flex justify-between mt-2 text-sm">
                                        <p>{{ $t('Available') }}: {{ state.currencyFormat(parseFloat(wallet.balance_deposit_rollover > 0 ? 0 : wallet.balance), wallet.currency) }} {{ wallet.currency }}</p>
                                        <p>{{ $t('Balance Rollover') }}: {{ state.currencyFormat(parseFloat(wallet.balance_deposit_rollover), wallet.currency) }} {{ wallet.currency }}</p>
                                    </div>
                                </div>
                            ...
                            <div class="mt-5">
                                ...
                                <div class="dark:text-gray-400 mb-3">
                                    ...
                                    <div class="flex justify-between mt-2">
                                        <p>{{ $t('Available') }}: {{ state.currencyFormat(parseFloat(wallet.balance_deposit_rollover > 0 ? 0 : wallet.balance), wallet.currency) }} {{ wallet.currency }}</p>
                                        <p>{{ $t('Balance Rollback') }}: {{ state.currencyFormat(parseFloat(wallet.balance_deposit_rollover), wallet.currency) }} {{ wallet.currency }}</p>
                                    </div>
                                </div>
