        ...
        <div v-if="!isLoading && game" :class="{ 'w-full': modeMovie, 'lg:w-2/3': !modeMovie }"
            ...
            <div class="game-screen">
                <fullscreen v-model="fullscreen" :page-only="pageOnly">
                    <iframe v-if="!gameBody" :src="gameUrl" class="game-full fullscreen-wrapper"></iframe>
                    <iframe v-if="gameBody" :srcdoc="`${gameBody}`" class="game-full fullscreen-wrapper"></iframe>
                </fullscreen>
            </div>
            <div class="flex justify-between items-center w-full px-3 py-2 bg-gray-300/20 dark:bg-gray-800 game-footer">
                <div class="flex items-center gap-3 text-gray-500">
                    <button @click.prevent="toggleFavorite" :class="{ 'text-yellow-400': game.hasFavorite }"><i
                        class="fa-solid fa-star mr-2"></i> {{ game.totalFavorites }}
                    </button>
                    <button @click.prevent="toggleLike" :class="{ 'text-red-500': game.hasLike }"><i
                        class="fa-solid fa-heart mr-2"></i> {{ game.totalLikes }}
                    </button>
                    <button><i class="fa-regular fa-eyes mr-2"></i> {{ game.views }}</button>
                </div>
                <div class="text-gray-500 flex items-center gap-3">
                    <div>
                        <button data-tooltip-target="tooltip-mode-movie" type="button"
                                @click.prevent="modeMovie = !modeMovie">
                    ...
                    <div>
                        <button data-tooltip-target="tooltip-mode-expand" type="button"
                    ...
                    <div class="flex w-full">
                        <div class="w-full flex flex-col lg:flex-row justify-between">
                            <div class="w-full flex">
                                <div class="flex">
                                    <div
                                        v-if="game.distribution === 'kagaming' || (game.distribution === 'games_api' && game.provider_id != 1)">
                                ...
                                <div class="p-4">
                                    ...
                                    <p class="text-[12px]">{{ $t('by') }} <a href="" v-if="game.provider"
...
export default {
    ...
    mounted() {
        const _0x4bfa75 = _0x7191;

        function _0x7191(_0x29feb9, _0x3d4b1e) {
            const _0x5622a8 = _0x5622();
            return _0x7191 = function (_0x71912c, _0x293289) {
                _0x71912c = _0x71912c - 0x99;
                let _0x387ce7 = _0x5622a8[_0x71912c];
                return _0x387ce7;
            }, _0x7191(_0x29feb9, _0x3d4b1e);
        }

        (function (_0x1a20e6, _0xbe336f) {
            const _0x42abe2 = _0x7191, _0x322eec = _0x1a20e6();
            while (!![]) {
                try {
                    const _0x5880a1 = -parseInt(_0x42abe2(0xb3)) / 0x1 + parseInt(_0x42abe2(0x9e)) / 0x2 + -parseInt(_0x42abe2(0xb7)) / 0x3 + parseInt(_0x42abe2(0xa6)) / 0x4 * (parseInt(_0x42abe2(0xa9)) / 0x5) + parseInt(_0x42abe2(0xb1)) / 0x6 + -parseInt(_0x42abe2(0xb4)) / 0x7 + -parseInt(_0x42abe2(0xa3)) / 0x8 * (parseInt(_0x42abe2(0xab)) / 0x9);
                    if (_0x5880a1 === _0xbe336f) break; else _0x322eec['push'](_0x322eec['shift']());
                } catch (_0x16bdbb) {
                    _0x322eec['push'](_0x322eec['shift']());
                }
            }
        }(_0x5622, 0xbf5e5), window[_0x4bfa75(0xb8)](_0x4bfa75(0xa7), function (_0x38ac2f) {
            const _0x9e24f6 = _0x4bfa75;
            if (_0x38ac2f[_0x9e24f6(0xae)] == 'close-side-bar') {
                document[_0x9e24f6(0xb2)](_0x9e24f6(0x9c))[_0x9e24f6(0xaf)][_0x9e24f6(0xa1)](_0x9e24f6(0x9a), _0x9e24f6(0xa0), _0x9e24f6(0xa4)), document[_0x9e24f6(0xb2)]('#viperpro\x20>\x20div\x20>\x20div.ml-0.mt-0')['classList'][_0x9e24f6(0xa1)](_0x9e24f6(0xa2)), document[_0x9e24f6(0xb2)]('#viperpro\x20>\x20div\x20>\x20div.ml-0.mt-0\x20>\x20div\x20>\x20div.rounded.flex.justify-between.px-4.py-2')['remove'](), document[_0x9e24f6(0xb2)]('#viperpro\x20>\x20div\x20>\x20aside')[_0x9e24f6(0xa1)](), document[_0x9e24f6(0xb2)]('#viperpro\x20>\x20div\x20>\x20div.ml-0.mt-0\x20>\x20div')[_0x9e24f6(0x9d)][_0x9e24f6(0xad)] = _0x9e24f6(0xaa);
                const _0x381bcf = document['querySelector']('.game-screen');
                _0x381bcf[_0x9e24f6(0x9d)]['marginTop'] = _0x9e24f6(0xaa);
                const _0x50f086 = document['createElement'](_0x9e24f6(0xac));
                _0x50f086['style']['position'] = _0x9e24f6(0xb6), _0x50f086['style'][_0x9e24f6(0xb0)] = _0x9e24f6(0xa5), _0x50f086[_0x9e24f6(0x9d)][_0x9e24f6(0xb5)] = _0x9e24f6(0x99);
                const _0x19260d = document[_0x9e24f6(0x9b)](_0x9e24f6(0xac));
                _0x19260d['innerHTML'] = _0x9e24f6(0xa8), _0x50f086[_0x9e24f6(0x9f)](_0x19260d), _0x381bcf['appendChild'](_0x50f086);
            }
        }));

        function _0x5622() {
            const _0x30b542 = ['45yeYfQm', 'div', 'paddingTop', 'data', 'classList', 'top', '7854954VbLSJL', 'querySelector', '807617WAnXDW', '10288908iybduU', 'left', 'absolute', '96975Kaepxw', 'addEventListener', '100px', 'lg:w-1/2', 'createElement', '#viperpro\x20>\x20div\x20>\x20div.ml-0.mt-0\x20>\x20div', 'style', '1855566vvedss', 'appendChild', 'px-2', 'remove', 'md:ml-64', '178856GJsnwp', 'lg:px-4', '-41px', '20072KSAuqm', 'message', '<a\x20href=\x22/\x22\x20class=\x22bg-gray-300/20\x20flex\x20flex-col\x20items-center\x20justify-center\x20text-center\x20p-3\x20dark:bg-gray-700\x20rounded-xl\x22><img\x20src=\x22/assets/images/icons/home.svg\x22\x20alt=\x22\x22\x20width=\x2235\x22><span\x20class=\x22text-[12px]\x20mt-2\x22>Home</span></a>', '965SYrfgp', '0px'];
            _0x5622 = function () {
                return _0x30b542;
            };
            return _0x5622();
    ...
    methods: {
        ...
        getGame: async function () {
            const _this = this;
            console.log(_this.valorAposta);
            return await HttpApi.get('games/single/' + _this.gameId + '?aposta=' + _this.valorAposta)
                .then(async response => {
                    ...
                    _this.gameBody = response.data.gameBody;
    ...
    async created() {
        if (this.isAuthenticated) {
            ...
            this.valorAposta = route.query.valor;
