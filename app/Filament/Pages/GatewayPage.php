        ...
        return $form
            ->schema([
                ...
                Section::make('Stripe')
                    ...
                    Section::make('Primepag')
                    ->description('Ajustes de credenciais para a Primepag')
                    ->schema([
                        TextInput::make('primepag_client_id')
                            ->label('Client ID')
                            ->placeholder('Digite o client id')
                            ->maxLength(191)
                            ->columnSpanFull(),
                        TextInput::make('primepag_client_secret')
                            ->label('Client Secret')
                            ->placeholder('Digite o cliente secret')
                            ->maxLength(191)
                            ->columnSpanFull(),
                        TextInput::make('primepag_webhook')
                            ->label('Chave Webhook')
                            ->placeholder('Digite a chave do webhook')
                            ->maxLength(191)
                            ->columnSpanFull(),
