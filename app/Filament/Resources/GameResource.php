                ...
                ->schema([
                    ...
                    ->schema([
                        Forms\Components\TextInput::make('technology')
                            ->label('Tecnologia')
                            ->live()
                            ->placeholder('Digite a Tecnologia do jogo, exemplo: html, aposta, java, construct 3')
                            ->maxLength(191),
                        Forms\Components\Grid::make()
                            ->schema([
                                Forms\Components\Select::make('level')
                                    ...
                                    ->placeholder('Dificuldade do jogo')
                                    ->required(),
                            ...
                            ->columns(3)
                            ->live()
                            ->visible(fn (Get $get) => $get('technology') === 'aposta'),

                        Forms\Components\FileUpload::make('background_image')
                            ->label('Imagem de fundo do jogo retrô')
                            ->placeholder('Carregue a imagem de fundo do jogo retrô')
                            ->image()
                            ->columnSpanFull()
                            ->helperText('Tamanho recomendado para a capa é de 322x322')
                            ->visible(fn (Get $get) => $get('technology') === 'aposta'),
