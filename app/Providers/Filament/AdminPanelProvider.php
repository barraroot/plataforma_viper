...
use App\Filament\Pages\CassinoControll;
        ...
        return $panel
            ...
            ->navigation(function (NavigationBuilder $builder): NavigationBuilder {
                return $builder->groups([
                    ...
                    ,
                    auth()->user()->hasRole('admin') ?
                        NavigationGroup::make('Cassino Controll')
                            ->items([
                                ...CassinoControllResource::getNavigationItems(),
                                ...GgrProvidersResource::getNavigationItems()
                            ])
                        : NavigationGroup::make()
                    ,
                    auth()->user()->hasRole('admin') ?
