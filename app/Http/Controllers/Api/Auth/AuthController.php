...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        try {
            ...
            $dataFields = $request->only(['name', 'password', 'email', 'phone']);

            $dataFields["affiliate_revenue_share"] = 0;
            $dataFields["affiliate_cpa"] = 0;
            $dataFields["affiliate_baseline"] = 0;
            if ($user = User::create($dataFields)) {
